...
<form method="post" action="<?php echo base_url();?>admin/editTestInfo" enctype="multipart/form-data">
	...
	<input type="number" class="chosen-select form-control" id="time_id" name="minutes"/><br>
