        ...
        <div id="navbar" class="navbar navbar-default          ace-save-state">
            <div class="navbar-container ace-save-state" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="<?php echo base_url();?>userController/index/<?php echo $this->session->userdata('userids');?>" class="navbar-brand">
                        <small>
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
                ...
                <ul class="nav nav-list">
                    <li class="active">
                        <a href="<?php echo base_url();?>userController/index/<?php echo $this->session->userdata('userids');?>">
                    ...
                    <li class="">
                                ...
                                <ul class="submenu">
                                            ...
                                            <li class="">
                                                <a href="<?php echo base_url();?>userController/examHistory/<?php echo $user_name;?>">
                                            ...
                                            <li class="">
                                                <a href="<?php echo base_url();?>userController/viewExams/<?php echo $user_name;?>">
                                                    <i class="menu-icon fa fa-plus purple"></i>
                                                    Take Test
                                                </a>
