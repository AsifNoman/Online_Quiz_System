...
('java', 'Programming', 1, 'This test is about 5 multiple choice questions and should take less than 1 minute to complete.For each correct answer 1 mark will be added.', 5),
...
--
ALTER TABLE `tbl_marks`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=263;
--
