...
<form method="post" action="<?php echo base_url();?>admin/searchResult" >

    <label> Search Mark By User Name </label>
...
<h2 align="center" class="text-info">All Users Mark History</h2><br>
<table class="table">
  <tr>
    <th>User Name</th>
    <th>Mark</th> 
