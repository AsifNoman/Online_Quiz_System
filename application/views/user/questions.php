        ...
        <div id="navbar" class="navbar navbar-default          ace-save-state">
            <div class="navbar-container ace-save-state" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="<?php echo base_url();?>userController/index/<?php echo $users['user_id'];?>" class="navbar-brand">
                        <small>
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
                ...
                <ul class="nav nav-list">
                    <li class="active">
                        <a href="<?php echo base_url();?>userController/index/<?php echo $users['user_id'];?>">
                    ...
                    <li class="">
                                ...
                                <ul class="submenu">
                                            ...
                                            <li class="">
                                                <a href="<?php echo base_url();?>userController/examHistory/<?php echo $users['user_name']?>">
                                            ...
                                            <li class="">
                                                <a href="<?php echo base_url();?>userController/viewExams/<?php echo $users['user_name']?>">
                                                    <i class="menu-icon fa fa-plus purple"></i>
                                                    Take Test
                                                </a>
...
<form action="<?php echo base_url();?>userController/result/<?php echo $all[0]['test_name']; ?>/<?php echo $users['user_id'];?>" method="post"> 
...
<label class="text-warning"><b><?php echo $i.".".$v_test['question'];?></b></label><br>
...
<?php $i++; ?>
<?php }?>
<input type="submit" class="btn btn-success" name="submit_button" value="Submit">
</form>
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        window.open("<?php echo base_url();?>questionController/result/<?php echo $all[0]['test_name']; ?>","_self");
    }
}, 1000);
