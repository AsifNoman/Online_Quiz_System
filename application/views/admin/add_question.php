...
<form method="post" action="<?php echo base_url();?>admin/addQuestion" enctype="multipart/form-data">

	<label> Test Name* </label>
	<input type="text" id="test_id" class="chosen-select form-control"  name="test_name" required /><br>

	<label> Category* </label>
	<select name="category" class="chosen-select form-control"  required>
	...
	<input type="number" class="chosen-select form-control" id="time_id" name="minutes" required/><br>

    <label> Details About Test: </label>
	<textarea name="details" class="chosen-select form-control" rows="3" cols="40"></textarea><br>

	<label> Upload File* </label>
	<input type="file" class="chosen-select form-control"  id="file_id" name="userfile" value="UPLOAD" required /><br>
